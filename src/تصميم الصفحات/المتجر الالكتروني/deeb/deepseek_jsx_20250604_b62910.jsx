...
import { FaCar, FaBuilding, FaTools, FaPalette, FaCrown, FaStar, FaGem } from 'react-icons/fa';
          ...
          <div>
            {product.discountPrice ? (
              <div className="flex items-baseline gap-2">
                <span className="text-xl font-bold text-topshield-primary-navy">{product.discountPrice.toLocaleString()} ر.س</span>
                <span className="text-topshield-text-medium line-through">{product.price.toLocaleString()} ر.س</span>
              </div>
            ) : (
              <span className="text-xl font-bold text-topshield-primary-navy">{product.price.toLocaleString()} ر.س</span>
            )}
          </div>
  ...
  const services: Service[] = [
    {
      ...
      link: "/store/services/installation",
      icon: <FaTools />
    },
    {
      id: "warranty",
    ...
    },
    {
      ...
      link: "/store/services/appointment",
      icon: <FiCalendar />
    }
  ];
            ...
            >
              <div className="container mx-auto px-4 py-6">
                <nav className="flex flex-col space-y-6 text-xl text-topshield-white">
                  <Link href={`/${currentLocale}/store#car-tinting`} passHref legacyBehavior>
                    <a className="flex items-center gap-3 py-3 border-b border-topshield-border-subtle/30">
                  ...
                  <Link href={`/${currentLocale}/contact`} passHref legacyBehavior>
                    <a className="bg-topshield-accent-gold text-topshield-primary-navy font-bold px-6 py-3 rounded-lg mt-4 text-center flex items-center justify-center gap-2">
